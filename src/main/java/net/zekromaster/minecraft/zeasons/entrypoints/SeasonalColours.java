...
public class SeasonalColours {
    ...
    private void addColourProviders(AttachSeasonPropertiesEvent event) {
        ...
        AUTUMN.setProperty(SeasonalColourProvider.PropertyKeys.OAK, (view, state) -> 0xfc8014);
        ...
        AUTUMN.setProperty(SeasonalColourProvider.PropertyKeys.BIRCH, (view, state) -> 0xe2c231);
        ...
        AUTUMN.setProperty(SeasonalColourProvider.PropertyKeys.GRASS, (view, state) -> 0xcfcd00);
        ...
        AUTUMN.setProperty(SeasonalColourProvider.PropertyKeys.TALL_GRASS, (view, state) -> 0xbfad41);
